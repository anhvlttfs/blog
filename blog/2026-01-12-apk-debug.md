...
If you obtain the hacker who just needs hacking, you may need to download the APK from an application store, such as ApkCombo. Once you've downloaded it, try unpacking the XAPK and start enabling debugging from the beginning.
